      ...
      <main className="max-w-6xl mx-auto px-6 pt-32 pb-32 flex flex-col gap-40">
        ...
        <section id="home" className="scroll-mt-40 flex flex-col lg:flex-row items-center gap-12 pt-10 relative">
          ...
          <div className="flex-1 flex flex-col gap-6 items-start">
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white via-emerald-100 to-emerald-500 leading-tight">
              Aditya Gupta
            </h1>
            ...
            <div className="relative mt-4 z-20">
              ...
              <div className={`absolute top-full left-0 mt-4 bg-black/60 backdrop-blur-xl border border-zinc-800 rounded-2xl p-2 min-w-[300px] shadow-2xl transition-all duration-300 origin-top ${showContact ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 -translate-y-2 pointer-events-none'}`}>
                <a href="mailto:YOUR_EMAIL_HERE@gmail.com" className="flex items-center gap-4 p-3 hover:bg-zinc-800/50 rounded-xl transition-colors group">
                ...
                <a href="https://github.com/YOUR_GITHUB_HERE" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-3 hover:bg-zinc-800/50 rounded-xl transition-colors group">
                  <div className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-700 flex items-center justify-center group-hover:border-emerald-400 group-hover:text-emerald-400 transition-colors">
        ...
        <section id="skills" className="scroll-mt-32 flex flex-col gap-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="bg-zinc-900/40 border border-zinc-800 hover:border-emerald-500/30 transition-colors p-6 rounded-xl">
              <div className="text-emerald-400 mb-4 text-sm font-bold uppercase tracking-wider">Languages</div>
              <p className="text-zinc-300 text-sm leading-loose">Python, JavaScript (ES6+), Java, C, SQL (MySQL, PostgreSQL), HTML5, CSS3</p>
            </div>

            <div className="bg-zinc-900/40 border border-zinc-800 hover:border-emerald-500/30 transition-colors p-6 rounded-xl">
              <div className="text-emerald-400 mb-4 text-sm font-bold uppercase tracking-wider">AI & Machine Learning</div>
              <p className="text-zinc-300 text-sm leading-loose">PyTorch, TensorFlow, Scikit-learn, Pandas, NLP, Time-Series Forecasting</p>
            </div>

            <div className="bg-zinc-900/40 border border-zinc-800 hover:border-emerald-500/30 transition-colors p-6 rounded-xl">
              <div className="text-emerald-400 mb-4 text-sm font-bold uppercase tracking-wider">Web Development</div>
              <p className="text-zinc-300 text-sm leading-loose">React.js, Node.js, Express, Flask, TypeScript, Chakra UI, Dash, RESTful APIs</p>
            </div>

            <div className="bg-zinc-900/40 border border-zinc-800 hover:border-emerald-500/30 transition-colors p-6 rounded-xl">
              <div className="text-emerald-400 mb-4 text-sm font-bold uppercase tracking-wider">Cloud & DevOps</div>
              <p className="text-zinc-300 text-sm leading-loose">AWS (S3/CloudFront), Docker, Kubernetes, Firebase, Apache Kafka, Git/GitHub</p>
            </div>

            <div className="bg-zinc-900/40 border border-zinc-800 hover:border-emerald-500/30 transition-colors p-6 rounded-xl">
              <div className="text-emerald-400 mb-4 text-sm font-bold uppercase tracking-wider">Databases & Caching</div>
              <p className="text-zinc-300 text-sm leading-loose">MongoDB, MySQL, PostgreSQL, SQLite, Redis</p>
            </div>

            <div className="bg-zinc-900/40 border border-zinc-800 hover:border-emerald-500/30 transition-colors p-6 rounded-xl">
              <div className="text-emerald-400 mb-4 text-sm font-bold uppercase tracking-wider">Core CS Fundamentals</div>
              <p className="text-zinc-300 text-sm leading-loose">OOP, DBMS, OS, Computer Networks, SIEM/SOAR</p>
            </div>
          </div>

          <div className="mt-6">
            <h3 className="text-sm font-bold text-zinc-500 uppercase tracking-wider mb-4">Completed Coursework</h3>
            <div className="flex flex-wrap gap-3">
              {["Data Structure And Algorithms", "Machine Learning", "Deep Learning", "Generative AI", "Cloud Computing", "Prompt Engineering"].map((course, idx) => (
                <span key={idx} className="bg-[#0a0a0a] border border-zinc-700/50 text-zinc-300 px-5 py-2 rounded-full text-xs hover:border-emerald-500/50 hover:text-emerald-300 transition-colors cursor-default shadow-sm">
                  {course}
                </span>
              ))}
            </div>
            ...
            <div className="group bg-zinc-900/20 border border-zinc-800/80 p-8 rounded-2xl hover:bg-zinc-900/40 hover:border-emerald-500/30 transition-all duration-300 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-xs text-emerald-500/80 mt-2 font-mono">Python, Kafka, React, Docker, Kubernetes, TensorFlow</p>
                </div>
                <div className="text-xs text-zinc-500 font-mono bg-black/50 px-3 py-1 rounded border border-zinc-800 w-fit">March 2026</div>
              </div>
            ...
            <div className="group bg-zinc-900/20 border border-zinc-800/80 p-8 rounded-2xl hover:bg-zinc-900/40 hover:border-emerald-500/30 transition-all duration-300 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-xs text-emerald-500/80 mt-2 font-mono">React, Node.js, MongoDB, Express, TypeScript, OpenAI</p>
                </div>
                <div className="text-xs text-zinc-500 font-mono bg-black/50 px-3 py-1 rounded border border-zinc-800 w-fit">October 2025</div>
              </div>
              <ul className="text-sm text-zinc-400 space-y-3 leading-relaxed list-disc list-outside ml-4 marker:text-zinc-700">
            ...
            <div className="group bg-zinc-900/20 border border-zinc-800/80 p-8 rounded-2xl hover:bg-zinc-900/40 hover:border-emerald-500/30 transition-all duration-300 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-xs text-emerald-500/80 mt-2 font-mono">Python, React.js, Node.js, AWS, Firebase, Chakra UI</p>
                </div>
                <div className="text-xs text-zinc-500 font-mono bg-black/50 px-3 py-1 rounded border border-zinc-800 w-fit">December 2024</div>
              </div>
              <ul className="text-sm text-zinc-400 space-y-3 leading-relaxed list-disc list-outside ml-4 marker:text-zinc-700">
            ...
            <div className="group bg-zinc-900/20 border border-zinc-800/80 p-8 rounded-2xl hover:bg-zinc-900/40 hover:border-emerald-500/30 transition-all duration-300 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-xs text-emerald-500/80 mt-2 font-mono">Python, Flask, SQLite, Pandas, Statsmodels</p>
                </div>
                <div className="text-xs text-zinc-500 font-mono bg-black/50 px-3 py-1 rounded border border-zinc-800 w-fit">August 2024</div>
              </div>
              <ul className="text-sm text-zinc-400 space-y-3 leading-relaxed list-disc list-outside ml-4 marker:text-zinc-700">
